...
- **Design log:** When implementing from a design log, cite its number and follow the implementation plan. Append "Implementation Results" when done. If there was no log and you suggest recording the change, tell the user to use the **/rust-design-review__adr-new** command with a slug.
